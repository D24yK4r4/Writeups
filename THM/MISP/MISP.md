...
<details><summary>How many distribution options does MISP provide to share threat information?</summary>

![Lab Screenshot](003.png)
4</details>

<details><summary>Which user has the role to publish events?</summary>
...
<details><summary>What event ID has been assigned to the PupyRAT event?</summary>
1145</details>

<details><summary>The event is associated with the adversary gaining ______ into organisations.</summary>
Remote Access</details>

<details><sumamry>What IP address has been mapped as the PupyRAT C2 Server</summary>
89.107.62.39</details>

<details><summary>From the Intrusion Set Galaxy, what attack group is known to use this form of attack?</summary>
Magic Hound</details>

<details><summary>There is a taxonomy tag set with a Certainty level of 50. Which one is it?</sumamry>
OSINT</details>
